...
BAD_WORDS = [
    # Uzbekcha
    "ahmoq", "tentak", "yaramas", "it", "onangni", "oneyni", "jinni", "ske", "poxuy", "pohuy", "poxxuy", "pohhuy"
    ...
    "kozel", "dalbayop", "shlyoxa", "xuyet", "huyet", "huyetqivosami", "xuyetqivosami", "huyetqivosanmi", "xuyetqivosanmi",
